...
function serializeWcPersonalMarker(summary) {
...
function parseWcPersonalMarker(content) {
...
function splitWcPersonalContent(content) {
...
module.exports = {
  WC_PERSONAL_MARKER_PREFIX,
  WC_PERSONAL_MARKER_SUFFIX,
  WC_PERSONAL_MARKER_REGEX,
  sanitizeWcPersonalSummary,
  serializeWcPersonalMarker,
  parseWcPersonalMarker,
  splitWcPersonalContent,
};
