...
describe('buildRoundRobinPlacings', () => {
  it('sorts by points, buchholz, pumbility, then seed', () => {
    const placings = buildRoundRobinPlacings([
      { id: 'p2', name: 'Bravo', points: 3, wins: 3, losses: 1, buchholz: 5, pumbility: 1100, seed_rank: 2 },
      { id: 'p1', name: 'Alpha', points: 3, wins: 3, losses: 1, buchholz: 7, pumbility: 1000, seed_rank: 1 },
      { id: 'p3', name: 'Charlie', points: 2, wins: 2, losses: 2, buchholz: 6, pumbility: 1200, seed_rank: 3 },
    ]);
