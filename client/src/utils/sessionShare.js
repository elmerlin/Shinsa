  ...
  const selectedRows = rows
    ...
    .map((play) => {
      ...
      return {
        ...
        replay_start_seconds: toInt(play?.replay_start_seconds),
        replay_end_seconds: toInt(play?.replay_end_seconds),
        perfect,
        great,
        good,
        bad,
    ...
    .map((play) => ({
      ...
      replay_start_seconds: play.replay_start_seconds,
      replay_end_seconds: play.replay_end_seconds,
