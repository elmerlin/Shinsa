...
export const LIVE_OVERLAY_THEMES = [
  {
    ...
    insetClass: 'border-white/10 bg-black/18 text-slate-100',
  ...
  },
  {
    ...
    insetClass: 'border-white/10 bg-black/18 text-stone-100',
    shadow: 'rgba(251, 146, 60, 0.2)',
  },
  {
    id: 'transparent',
    label: 'Transparent Rail',
    surface: 'transparent',
    panelClass: 'backdrop-blur-0',
    chipClass: 'border-white/0 bg-transparent text-slate-100',
    accentClass: 'border-cyan-300/38 bg-cyan-300/8 text-cyan-50',
    strongClass: 'border-rose-300/36 bg-rose-300/8 text-rose-50',
    altClass: 'border-amber-300/34 bg-amber-300/8 text-amber-50',
    faintClass: 'border-white/12 bg-black/0 text-slate-200',
    insetClass: 'border-white/12 bg-black/0 text-slate-100',
    shadow: 'rgba(0, 0, 0, 0)',
