...
export const getCurrentPetRequest = () => request('/pets/requests/current');
export const completeCurrentPetRequest = () => request('/pets/requests/current/complete', { method: 'POST' });
export const dismissCurrentPetRequest = () => request('/pets/requests/current/dismiss', { method: 'POST' });
