...
// Both dirt and stone path tilesets follow the same 4×4 wang convention.
const WANG_DIRT_GRASS  = 'Tiles/wang_dirt_grass.png';
const WANG_STONE_GRASS = 'Tiles/wang_grass_path.png';
...
function pathTextureForVariant(variant) {
  return variant === 'stone' ? WANG_STONE_GRASS : WANG_DIRT_GRASS;
}
