...
export const ARCHETYPES = {
  ...
  flier: {
    ...
    targetLayers: [COMBAT_LAYERS.AIR, COMBAT_LAYERS.GROUND],
    targetPriority: [COMBAT_LAYERS.GROUND, COMBAT_LAYERS.AIR],
...
export const PET_UNIT_VARIANTS = {
  dojocat: {
    ...
    flier: {
      battleNote: 'Winged cat monk gliding on air currents',
      accessoryKey: 'cloud_strider',
  ...
  buu: {
    ...
    flier: {
      battleNote: 'Round majin with fluttering star wings',
      accessoryKey: 'soaring_majin',
  ...
  devit: {
    ...
    flier: {
      battleNote: 'Tiny demon imp with flickering bat wings',
      accessoryKey: 'hellwing_imp',
  ...
  pixiu: {
    ...
    flier: {
      battleNote: 'Celestial phoenix spirit with jade wings',
      accessoryKey: 'jade_phoenix',
