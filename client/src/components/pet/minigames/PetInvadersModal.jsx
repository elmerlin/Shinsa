...
export default function PetInvadersModal({ open, onClose, character, onComplete, stats, leaderboard }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col overflow-hidden bg-[#020408] select-none" style={{ WebkitTouchCallout: 'none', overscrollBehavior: 'none' }} onContextMenu={(e) => e.preventDefault()}>
      {/* Top bar */}
