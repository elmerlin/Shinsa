        ...
        <div className="grid grid-cols-[96px_auto_96px] items-center">
          <div className="flex items-center gap-0.5">
            <button
              ...
              onClick={goPrevLevel}
              disabled={!canGoPrev}
              className="w-11 h-11 rounded-md text-gray-500 hover:text-gray-100 hover:bg-white/[0.04] active:bg-white/[0.07] disabled:opacity-25 disabled:hover:bg-transparent disabled:hover:text-gray-500 transition-colors flex items-center justify-center"
          ...
          <div className="flex items-center justify-end gap-0.5">
            <button
              ...
              className="w-11 h-11 rounded-md text-gray-500 hover:text-gray-100 hover:bg-white/[0.04] active:bg-white/[0.07] transition-colors flex items-center justify-center"
