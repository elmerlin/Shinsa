              ...
              <div key={i} className="flex items-center gap-3 py-1.5 border-b border-piu-border/20 last:border-0">
                <Link to={chartLink} className="shrink-0">
                  {jacketUrl ? (
                    ...
                    <div className="w-9 h-9 rounded bg-piu-dark flex items-center justify-center font-display font-bold text-sm text-gray-500 hover:brightness-110 transition-all">{(u.song_title || '?')[0]}</div>
                  )}
                </Link>
                <div className="flex-1 min-w-0">
