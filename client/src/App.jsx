...
function UserMenu() {
  ...
  const drawer = open && typeof document !== 'undefined' ? createPortal(
    <div className="fixed inset-0 z-[110]">
      ...
      />
      <aside className="absolute right-0 top-0 z-10 h-full w-[68vw] max-w-[280px] border-l border-piu-border bg-piu-card shadow-2xl overflow-y-auto overscroll-contain sm:w-[320px] sm:max-w-[320px]">
